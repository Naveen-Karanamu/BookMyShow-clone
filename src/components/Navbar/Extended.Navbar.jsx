...
const ExtendedNav = () => {
    return (<>
        <div className="hidden lg:flex bg-commonPink-400 h-10 items-center  sticky top-16 z-40">
        ...
        <div className="hidden md:flex lg:hidden bg-commonPink-400 h-10 items-center md:h-8 md:fixed md:top-14 md:w-full md:z-40">
