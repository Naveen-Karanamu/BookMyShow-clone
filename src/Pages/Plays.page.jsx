                    ...
                    <div className=' w-full mt-3'>
                        ...
                        <div className='flex flex-wrap w-full lg:gap-3'>
                            <div className='w-1/2 py-2 md:py-4 lg:w-56'>
                                <Poster src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAyIEphbg%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00319661-vsrrwpaely-portrait.jpg" alt="plays images" title="Mookajjaiya Kanasugalu" subtitle="Ranga Shankara: Bengaluru Kannada ₹150" />
                            </div>
                            <div className='w-1/2 py-2 md:py-4 lg:w-56'>
                                <Poster src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAyIEphbg%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00319661-vsrrwpaely-portrait.jpg" alt="plays images" title="Mookajjaiya Kanasugalu" subtitle="Ranga Shankara: Bengaluru Kannada ₹150" />
                            </div>
